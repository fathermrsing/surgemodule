  ...
  config["proxy-groups"] = [       
    {
      ...
      name: "节点选择",
      proxies: ["tencentservice","DIRECT","HK 节点选择", "SG 节点选择", "JP 节点选择", "US 节点选择"],
      type: "url-test",
      interval: 300,
    },
    {  
    ...
    },    
    {
      ...
      name: "AIGC",
      type: "select",
      proxies: ["SG 节点选择", "JP 节点选择", "US 节点选择","DIRECT"],
    },
    {
      icon: "https://testingcf.jsdelivr.net/gh/Orz-3/mini@master/Color/Telegram.png",
      name: "Telegram",
      type: "select",
      proxies: ["HK 节点选择", "SG 节点选择", "JP 节点选择", "US 节点选择","DIRECT"],
    },
    {
    ...
    },
    {
      ...
      "include-all": true,
      "exclude-filter": "(?i)GB|Traffic|Expire|Premium|频道|订阅|ISP|流量|到期|重置",
      proxies: ["节点选择", "HK 节点选择", "SG 节点选择", "JP 节点选择", "US 节点选择"],
      name: "GLOBAL",
      type: "select",
    }
  ];
